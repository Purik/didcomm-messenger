...
class PongScenarioImpl(val eventRepository: EventRepository, val eventUseCase: EventUseCase) : BaseScenario() {
    ...
    override fun onScenarioEnd(id: String,success: Boolean, error: String?) {
        eventUseCase.pongMutableLiveData.postValue(Pair(true, error?:""))
    }
