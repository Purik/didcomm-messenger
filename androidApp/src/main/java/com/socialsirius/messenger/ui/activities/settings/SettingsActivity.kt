...
import com.socialsirius.messenger.databinding.ActivitySettingsBinding
...
class SettingsActivity : BaseActivity<ActivitySettingsBinding, SettingsActivityModel>() {
