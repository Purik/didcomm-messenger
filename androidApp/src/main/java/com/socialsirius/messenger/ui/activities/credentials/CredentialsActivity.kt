...
import com.socialsirius.messenger.databinding.ActivityCredentialsBinding
...
class CredentialsActivity : BaseActivity<ActivityCredentialsBinding, CredentialsActivityModel>() {
