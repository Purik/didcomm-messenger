...
public class PlayerVisualizerSeekbar extends AppCompatSeekBar {
    ...
    private void init() {
        ...
        playedStatePainting.setColor(ContextCompat.getColor(getContext(), R.color.defaultColor));
        notPlayedStatePainting.setStrokeWidth(1f);
        notPlayedStatePainting.setAntiAlias(true);
        notPlayedStatePainting.setColor(ContextCompat.getColor(getContext(), R.color.hintColor));
    }
